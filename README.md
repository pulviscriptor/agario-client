...
- `client.facebook_key` key to login. You can get it on [agar.io](http://agar.io) by log-in through Facebook and writing in console `JSON.parse(localStorage.loginCache).fa`
